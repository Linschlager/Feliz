...
type style =
    ...
    ///     grid.templateWidth (length.px 100)
    ...
    /// **F#**
    /// ```f#
    /// style.gridColumnStart (grid.span "odd-col")
    /// ```
    ...
    /// **F#**
    /// ```f#
    /// style.gridColumnEnd (grid.span 2)
    /// ```
    ...
    /// **F#**
    /// ```f#
    /// style.gridRowStart (grid.span "odd-col")
    /// ```
    ...
    /// ```
    static member inline gridColumn(start: string, end': string) = Interop.mkStyle "gridColumn" (start + " / " + end')
    /// Determines a grid item’s location within the grid by referring to specific grid lines.
    /// start is the line where the item begins, end' is the line where it ends.
    /// They can be one of the following options:
    /// - a named line
    ...
    /// ```
    static member inline gridColumn(start: string, end': int) = Interop.mkStyle "gridColumn" (start + " / " + (unbox<string>end'))
    /// Determines a grid item’s location within the grid by referring to specific grid lines.
    /// start is the line where the item begins, end' is the line where it ends.
    /// They can be one of the following options:
    /// - a named line
    ...
    /// **F#**
    /// ```f#
    /// style.gridColumn ("col-2", grid.span 2)
    /// ```
    static member inline gridColumn(start: string, end': IGridSpan) = Interop.mkStyle "gridColumn" (start + " / " + (unbox<string>end'))
    /// Determines a grid item’s location within the grid by referring to specific grid lines.
    /// start is the line where the item begins, end' is the line where it ends.
    /// They can be one of the following options:
    /// - a named line
    ...
    /// ```
    static member inline gridColumn(start: int, end': string) = Interop.mkStyle "gridColumn" ((unbox<string>start) + " / " + end')
    /// Determines a grid item’s location within the grid by referring to specific grid lines.
    /// start is the line where the item begins, end' is the line where it ends.
    /// They can be one of the following options:
    /// - a named line
    ...
    /// ```
    static member inline gridColumn(start: int, end': int) = Interop.mkStyle "gridColumn" ((unbox<string>start) + " / " + (unbox<string>end'))
    /// Determines a grid item’s location within the grid by referring to specific grid lines.
    /// start is the line where the item begins, end' is the line where it ends.
    /// They can be one of the following options:
    /// - a named line
    ...
    /// ```
    static member inline gridRow(start: string, end': string) = Interop.mkStyle "gridRow" (start + " / " + end')
    /// Determines a grid item’s location within the grid by referring to specific grid lines.
    /// start is the line where the item begins, end' is the line where it ends.
    /// They can be one of the following options:
    /// - a named line
    ...
    /// ```
    static member inline gridRow(start: string, end': int) = Interop.mkStyle "gridRow" (start + " / " + (unbox<string>end'))
    /// Determines a grid item’s location within the grid by referring to specific grid lines.
    /// start is the line where the item begins, end' is the line where it ends.
    /// They can be one of the following options:
    /// - a named line
    ...
    /// ```
    static member inline gridRow(start: int, end': string) = Interop.mkStyle "gridRow" ((unbox<string>start) + " / " + end')
    /// Determines a grid item’s location within the grid by referring to specific grid lines.
    /// start is the line where the item begins, end' is the line where it ends.
    /// They can be one of the following options:
    /// - a named line
    ...
    /// style.gridRow (2, 4)
    /// ```
    static member inline gridRow(start: int, end': int) = Interop.mkStyle "gridRow" ((unbox<string>start) + " / " + (unbox<string>end'))
    /// Determines a grid item’s location within the grid by referring to specific grid lines.
    /// start is the line where the item begins, end' is the line where it ends.
    /// They can be one of the following options:
    /// - a named line
